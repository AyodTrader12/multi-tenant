  ...
  return (
    <div>
      <main className="grid grid-cols-8 gap-3 m-2 ">
        <main className="overflow-x-auto fixed w-[300px] col-span-2 rounded-md border h-[100vh] bg-slate-100">
          <div>
        ...
        <main className="col-span-4 rounded-md border w-[1200px] min-h-[600px] bg-slate-50 flex justify-center">
          <Outlet />
        </main>

        <main className="col-span-2 fixed overflow-x-auto left-[900px]  rounded-md border min-h-[400px] bg-slate-100">
          <ViewFriends />
        </main>
      </main>
    </div>
