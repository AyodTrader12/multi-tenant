      ...
      <main>
        ...
        <div className="flex justify-end gap-2">
          ...
          <button onClick={handlePost}>
            {loading ? (
              <div className="flex items-center gap-1 bg-black text-white px-6 py-2 text-[12px] rounded-md">
                <FaSpinner className="animate-spin " />
                <p>Posting</p>
              </div>
            ) : (
              <div className="bg-black text-white px-10 py-2 text-[12px] rounded-md">
                Post
              </div>
            )}
          </button>
